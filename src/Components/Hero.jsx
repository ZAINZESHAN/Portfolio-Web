            ...
            <div className='container w-full gap-10 lg:gap-0 h-[100vh] lg:h-[70vh] xl:h-[100vh] pt-20 flex items-center justify-center flex-col-reverse lg:flex-row'>
                ...
                <div className='text-center lg:text-left lg:w-[50%]'>
                    <div className='home_data text-white'>
                        ...
                        <h1 className="text_typing font-Viga text-[46px] md:text-[55px] md:mt-[-25px] lg:text-[40px] xl:text-[70px] mt-[-13px] font-semibold" data-text="Zain Zeeshan">
                            Zain Zeeshan
                        </h1>
                    ...
                    <div className="links_data flex md:flex-row flex-col items-center justify-center lg:justify-start gap-8 md:gap-3 xl:gap-5 text-lg pt-5 xl:pt-10 ">
                        <div>
