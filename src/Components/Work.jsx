        ...
        <div className='text-center'>
          <div className='work_heading'>
            ...
            <p className='text-[14px] md:text-[16px] font-semibold lg:text-[18px] xl:text-[19px] text-gray-200'>
              Here you will find insights into my projects, the challenges I’ve tackled, the technologies I’ve employed, and the impact of my contributions in the realm of development.          </p>
          </div>
