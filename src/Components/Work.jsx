...
const slideData = [
  { index: '01', title: 'Frontend Project', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque, labore a explicabo.', skills: 'Html 5, Css 3, Javascript' },
  { index: '02', title: 'Frontend Project', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque, labore a explicabo.', skills: 'Html 5, Css 3, Javascript' },
  { index: '03', title: 'Frontend Project', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque, labore a explicabo.', skills: 'Html 5, Css 3, Javascript' },
  { index: '04', title: 'Frontend Project', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque, labore a explicabo.', skills: 'Html 5, Css 3, Javascript' },
      ...
      <div className='container py-10 text-white text-center'>
        ...
        <div className='pt-10 md:pt-16'>
          ...
          <Swiper
            ...
            className='p-32'
          >
            {slideData.map(({ index, title, description, skills }) => (
              <SwiperSlide key={index} className='pb-1 lg:pb-10 xl:pb-14'>
                <div className='text-left flex h-[42vh] md:h-[54vh] lg:h-auto lg:flex-row flex-col lg:justify-between md:gap-5 lg:gap-10 xl:gap-20 relative'>
                  ...
                  <div className='lg:w-[50%]'>
                    <img src={work_img} alt='Project Image' className='w-[100%] h-[100%]' />
                  </div>
                </div>
              </SwiperSlide>
            ))}
